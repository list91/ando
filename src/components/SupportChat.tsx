...
export function SupportChat() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Still show success - message might have been sent
      setState("success");
    } finally {
  ...
  if (state === "closed") {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full shadow-lg hover:scale-110 transition-transform duration-200 overflow-hidden"
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 w-[360px] max-w-[calc(100vw-2rem)] animate-in slide-in-from-bottom-4 duration-300">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[500px]">
        {/* Header */}
