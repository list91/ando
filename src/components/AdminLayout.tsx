...
import { Package, ShoppingCart, LayoutDashboard, LogOut, Settings, Image as ImageIcon, FileText, Folder, ImagePlay, Info, Percent } from 'lucide-react';
  ...
  const navSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/admin/hero-slides', label: 'Главное фото', icon: ImageIcon },
